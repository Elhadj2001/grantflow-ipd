...
export const ErrorCode = {
  ...
  BUSINESS: {
    ...
    ELIGIBILITY_VALIDATION_FAILED: 'BUSINESS.ELIGIBILITY_VALIDATION_FAILED',
    ...
    /** Sprint S6 — Workflow Note Technique (ADR-006) : transitions d'état. */
    NOTE_TECHNIQUE_INVALID_TRANSITION:        'BUSINESS.NOTE_TECHNIQUE_INVALID_TRANSITION',
    NOTE_TECHNIQUE_REJECTION_REASON_REQUIRED: 'BUSINESS.NOTE_TECHNIQUE_REJECTION_REASON_REQUIRED',
    /** Sprint S6 (US-053, ADR-009) — séparation des tâches : créateur ≠ valideur. */
